---
title: "Neural signature holdout"
author: "Dani Cosme"
date: "`r Sys.Date()`"
output:
  html_document:
...
```{r}
metadata = read.csv("../data/metadata/metadata_cuereact.csv", stringsAsFactors = FALSE)

classifier_data = read.csv("../data/dots_cond.csv", stringsAsFactors = FALSE) %>%
...
`r emo::ji("x")` Out of sample predictive accuracy in the hold out sample is not significantly above chance
